<template>
	<view class="uni-calendar">
		<view v-if="!insert && show" class="uni-calendar__mask" :class="{ 'uni-calendar--mask-show': aniMaskShow }"
			@click="clean"></view>
		<view v-if="insert || show" class="uni-calendar__content" :class="{
			...
			<view class="uni-calendar__box">
				...
				<view class="uni-calendar__weeks" v-for="(item, weekIndex) in weeks" :key="weekIndex">
					<view class="uni-calendar__weeks-item" v-for="(weeks, weeksIndex) in item" :key="weeksIndex">
						<calendar-item :class="[getItemClass(weeks)]" :weeks="formatWeeks(weeks)" :calendar="calendar"
...
<script>
	...
	export default {
		...
		methods: {
			 ...
			 */
			getItemClass(weeks) {
				return ["uni-calendar-item--hook"].concat(
					typeof this.itemClassName === "function" ?
					this.itemClassName.call(this.$parent, weeks.fullDate) :
					void 0
				);
			},
			/**
			...
			formatWeeks(weeks) {
				if (typeof this.disableDate === "function") {
					return Object.assign(weeks, {
						disable: this.disableDate.call(this.$parent, weeks.fullDate),
					});
				}
...
<style lang="scss" scoped>
	$uni-bg-color-mask: rgba($color: #000000,
		$alpha: 0.4,
	);
